...
/**
 * Executes `node disconnect FROM TO` command.
 *
 * @author Sven Strittmatter <weltraumschaf@googlemail.com>
 */
class NodeDisconnect extends BaseCommand {
     ...
     */
    public NodeDisconnect(final Environment env, final IO io, final List<Token> arguments) {
